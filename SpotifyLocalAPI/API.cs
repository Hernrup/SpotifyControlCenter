...
namespace SpotifyLocalApi
{
    public class API
    {
        ...
        public API(string OAuth, string Host)
        {
            _oauth = OAuth;
            _host = Host;
        ...
        public Status Play
        {
            get
            {
                ...
                List<Status> d = (List<Status>)JsonConvert.DeserializeObject(a, typeof(List<Status>));
                return d[0];
            }
        }
        ...
        public ClientVersion ClientVersion
        {
            get
            {
                ...
                List<ClientVersion> d = (List<ClientVersion>)JsonConvert.DeserializeObject(a, typeof(List<ClientVersion>));
                return d[0];
            }
        }
    }
